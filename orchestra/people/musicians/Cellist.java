...
public class Cellist extends Person implements Musician{
    ...
    public void playNextNote() throws MidiUnavailableException {
        ...
        //Use iterator, create a new int no which represents a note (the next note), make soundSystem play the next note with correct seat and loudness
        if (nextNote.hasNext()){
